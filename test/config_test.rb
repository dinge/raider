...
module Raider
  module Config
    class RenamePdfsConfigTest < Minitest::Test
      def test_default_config_values
        config = RenamePdfsConfig.new
      ...
      def test_config_from_args
        ...
        config = RenamePdfsConfig.from_args(args)
      ...
      def test_validates_directory
        assert_raises(SystemExit) do
          ...
          capture_io do
            RenamePdfsConfig.from_args(["nonexistent/directory"])
          end
        end
      end
